...
| A | Jump |
| B | Interact - Double Jump ability ( unlockable ) |
...
| Right/Left Trigger | Dash ( unlockable )
...
| --- | --- |
| Left stick | Move |
| Right stick | Turn Move camera around ship|
| Right stick click | Pause menu |
...
- During some animations the head may briefly get in the way, this is unavoidable, if it disturb you hide the body throught the game opions
